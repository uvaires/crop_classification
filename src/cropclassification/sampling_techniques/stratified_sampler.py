...
def stratified_sampling(image_path: str, base_dir: str, samples_per_class: dict, buffer_size=10,
    ...
    """
    samples_points_dir = os.path.join(base_dir, 'results', 'sample_points', 'stratified_sampling')
